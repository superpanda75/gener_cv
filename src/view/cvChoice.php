...
@session_start();
var_dump($_SESSION); ?>
<form id="cv_model" action="index.php?page=cvChoiceController" method="post">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="width: 800px; height: 100px; margin: 0 auto">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item active">
            <img src="src/content/model1/assets/model1.png" alt="Model 1">
        </div>

        <div class="item">
            <img src="src/content/model2/assets/model2.png" alt="Model 2">
        </div>

        <div class="item">
            <img src="src/content/model3/assets/model3.png" alt="Model 3">
        </div>

        <div class="item">
            <img src="src/content/model4/assets/model4.png" alt="Model 4">
        </div>

        <div class="item">
            <img src="src/content/model5/assets/model5.png" alt="Model 5">
        </div>
